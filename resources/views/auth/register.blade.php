@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Registro de usuario')])
      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            ...
            <!-- users_id_rol -->
            <div class="bmd-form-group{{ $errors->has('users_id_rol') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">
                      <i class="material-icons">fingerprint</i>
                ...
                <input type="text" name="users_id_rol" class="form-control" placeholder="{{ __('Rol...') }}" value="{{ old('users_id_rol') }}" required autocomplete="users_id_rol">
              </div>
              @if ($errors->has('users_id_rol'))
                <div id="users_id_rol-error" class="error text-danger pl-3" for="users_id_rol" style="display: block;">
                  <strong>{{ $errors->first('users_id_rol') }}</strong>
                </div>
              @endif
            </div>
